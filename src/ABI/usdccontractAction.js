...
export const getUSDCContractBalance = async () => {
...
export const getUSDCDepositLimit = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const SetUSDTDeposite = async (value) => {
  ...
  if (window.ethereum) {
    ...
    const USDCStake = await contracts.methods.deposit(_finalamount).send({ from: account });
    if (USDCStake) {
...
export const SetUSDTDeposite1 = async (value) => {
  ...
  try {
    ...
    const account = userAccount[0];
    const currentChainId = await Metaweb3.eth.net.getId();
    if (currentChainId !== 137) {
      await Metaweb3.currentProvider.request({
        method: "wallet_switchEthereumChain",
        params: [{ chainId: Web3.utils.toHex(137) }],
      });
    }
    ...
    Gas = parseFloat(Gas).toString(16);
...
export const SetApprove = async () => {
  ...
  if (window.ethereum) {
    ...
    const USDCApprove = await contracts.methods.approve(Contractaddress, "100000000000000000000000000000000000").send({ from: account });
    if (USDCApprove) {
      if (window.confirm("Successfully Approve")) {
        window.location.reload();
      }
    }
  }
...
export const getUSDCUserBalance = async () => {
  if (window.ethereum) {
    //const web3 = new Web3(window.ethereum);
    await window.ethereum.request({ method: "eth_requestAccounts" });
    // Get the selected account
...
export const claimRewards = async () => {
  try {
    ...
    const userAccount = await Metaweb3.eth.getAccounts();
    const account = userAccount[0];
    let Gas = await GrayContract.methods.claimRewards().estimateGas({ from: account, gas: gasmax });
...
export const getUSDCContribution = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCInvestor = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const investors = await GrayContract.methods.totalInvestors().call();
  return investors;
};

export const getUSDCClaimable = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  await window.ethereum.request({ method: "eth_requestAccounts" });
  // Get the selected account
  const accounts = await window.ethereum.request({ method: "eth_accounts" });
...
export const getUSDCRewardsToDeposit = async (value) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCTotalRewardPaid = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const SetUSDCClaim = async () => {
  if (window.ethereum) {
    const web3 = new Web3(window.ethereum);
    await window.ethereum.request({ method: "eth_requestAccounts" });
    // Get the selected account
    ...
    const contracts = new web3.eth.Contract(abi, Contractaddress);
    const usdcClaim = await contracts.methods.claimRewards().send({ from: account });
    if (usdcClaim) {
...
export const getUSDCUserDeposits = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
// set USDC withdraw
export const SetUSDCWithdraw = async (_id) => {
  if (window.ethereum) {
    const web3 = new Web3(window.ethereum);
    await window.ethereum.request({ method: "eth_requestAccounts" });
    // Get the selected account
...
export const getUSDCUserDepositsIds = async (account) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getUSDCDepositData = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getUSDCDeposits_depositDate = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getUSDCDeposits_endDate = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
  let res_depositDate = response.depositTimestamp;
...
export const getUSDCDeposits_active = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
...
export const getUSDCDeposits_depositAmount = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
...
export const getUSDCepochReturns = async (value) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCLatestepoch = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const response = await GrayContract.methods.latestInitializedEpoch().call();
  return response;
};

export const getUSDCEpochLimits = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCcurrentepoch = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCTotalReturnForPeriod = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getUSDCUserAllRewardsWithdrawn = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
