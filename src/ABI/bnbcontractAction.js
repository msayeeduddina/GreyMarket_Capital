...
var Contractaddress = "0x429Dfa7C6463391Fa331DEb46C696C9E5a01753a";
...
export const getBNBContractBalance = async () => {
...
export const getBNBDepositLimit = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getBNBTotalRewardPaid = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const SetBNBDeposite = async (value) => {
  if (window.ethereum) {
    ...
    const BNBStake = await contracts.methods.deposit(_finalamount).send({ from: account, value: _finalamount });
    if (BNBStake) {
...
export const getBNBContribution = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getBNBInvestor = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const investors = await GrayContract.methods.totalInvestors().call();
  return investors;
};

export const getBNBClaimable = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  await window.ethereum.request({ method: "eth_requestAccounts" });
  // Get the selected account
  const accounts = await window.ethereum.request({ method: "eth_accounts" });
...
export const getBNBRewardsToDeposit = async (value) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const SetBNBClaim = async () => {
  if (window.ethereum) {
    const web3 = new Web3(window.ethereum);
    await window.ethereum.request({ method: "eth_requestAccounts" });
    // Get the selected account
    ...
    const contracts = new web3.eth.Contract(abi, Contractaddress);
    const bnbClaim = await contracts.methods.claimRewards().send({ from: account });
    if (bnbClaim) {
...
export const getBNBUserDeposits = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
//epoc return & latest epoch & current epoch
export const getBNBepochReturns = async (value) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getBNBLatestepoch = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const response = await GrayContract.methods.latestInitializedEpoch().call();
  return response;
};

export const getBNBEpochLimits = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getBNBcurrentepoch = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const getBNBTotalReturnForPeriod = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
...
export const SetBNBWithdraw = async (_id) => {
  if (window.ethereum) {
    const web3 = new Web3(window.ethereum);
    await window.ethereum.request({ method: "eth_requestAccounts" });
    // Get the selected account
...
export const getBNBUserDepositsIds = async (account) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getBNBDepositData = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getBNBDeposits_depositDate = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
...
export const getBNBDeposits_endDate = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
  let res_depositDate = response.depositTimestamp;
...
export const getBNBDeposits_active = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
...
export const getBNBDeposits_depositAmount = async (_id) => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const depositId = _id;
  const response = await GrayContract.methods.deposits(depositId).call();
...
export const getBNBUserAllRewardsWithdrawn = async () => {
  let GrayContract = new web3.eth.Contract(abi, Contractaddress);
  const accounts = await window.ethereum.request({
    method: "eth_accounts",
  });
